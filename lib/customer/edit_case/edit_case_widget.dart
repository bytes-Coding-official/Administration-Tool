...
import 'edit_case_model.dart';
export 'edit_case_model.dart';

class EditCaseWidget extends StatefulWidget {
  const EditCaseWidget({
    super.key,
  ...
  @override
  State<EditCaseWidget> createState() => _EditCaseWidgetState();
}

class _EditCaseWidgetState extends State<EditCaseWidget>
    with TickerProviderStateMixin {
  late EditCaseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditCaseModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'EditCase'});
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            controller: _model.productNameTextController ??=
                              ...
                              text: editCaseCustomerCaseRecord.title,
                            ),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            controller: _model.descriptionTextController ??=
                                TextEditingController(
                              text: editCaseCustomerCaseRecord.description,
                            ),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            controller: _model.textController3 ??=
                                TextEditingController(
                              text: editCaseCustomerCaseRecord.github,
                            ),
                        ...
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              8.0, 0.0, 8.0, 0.0),
                          child: TextFormField(
                            controller: _model.salesPriceTextController ??=
                                TextEditingController(
                              text:
                                  editCaseCustomerCaseRecord.revenue.toString(),
                            ),
                            focusNode: _model.salesPriceFocusNode,
                            autofocus: false,
                            obscureText: false,
                            decoration: InputDecoration(
                              labelText: FFLocalizations.of(context).getText(
                            ...
                            textAlign: TextAlign.center,
                            validator: _model.salesPriceTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                        Text(
                          FFLocalizations.of(context).getText(
                            '4kk0zsz3' /* Customer Name */,
                          ),
                          style: FlutterFlowTheme.of(context)
                              .labelMedium
                              .override(
                        ...
                        StreamBuilder<List<CustomerRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return FlutterFlowDropDown<String>(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'q2ma1w3x' /* Customer Name */,
                              ),
                              searchHintText:
                                  FFLocalizations.of(context).getText(
                                '6nsyd1pt' /* Search for an user... */,
                              ),
                              icon: Icon(
                                Icons.keyboard_arrow_down_rounded,
                                color:
                        ...
                        Align(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'EDIT_CASE_PAGE_SAVE_BTN_ON_TAP');
