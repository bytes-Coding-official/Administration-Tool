...
import 'chat2_invite_users_kunde_model.dart';
export 'chat2_invite_users_kunde_model.dart';

class Chat2InviteUsersKundeWidget extends StatefulWidget {
  const Chat2InviteUsersKundeWidget({
    super.key,
    this.chatRef,
  });
  ...
  @override
  State<Chat2InviteUsersKundeWidget> createState() =>
      _Chat2InviteUsersKundeWidgetState();
}

class _Chat2InviteUsersKundeWidgetState
    extends State<Chat2InviteUsersKundeWidget> with TickerProviderStateMixin {
  late Chat2InviteUsersKundeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Chat2InviteUsersKundeModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'chat_2_InviteUsersKunde'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      logFirebaseEvent('CHAT_2_INVITE_USERS_KUNDE_chat_2_InviteU');
      if (widget.chatRef != null) {
        // addChatUsers_ToList
        logFirebaseEvent('chat_2_InviteUsersKunde_addChatUsers_ToL');
        _model.friendsList =
            widget.chatRef!.users.toList().cast<DocumentReference>();
        setState(() {});
      } else {
        // addUser_ToList
        logFirebaseEvent('chat_2_InviteUsersKunde_addUser_ToList');
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              leading: FlutterFlowIconButton(
                ...
                onPressed: () async {
                  logFirebaseEvent('CHAT_2_INVITE_USERS_KUNDE_arrow_back_rou');
              ...
              title: Column(
                ...
                children: [
                  ...
                  Text(
                    FFLocalizations.of(context).getText(
                      'v4apm1on' /* Select users from below to sta... */,
                    ),
                                          ...
                                          child: Theme(
                                            ...
                                            child: CheckboxListTile(
                                              ...
                                              onChanged: (newValue) async {
                                                ...
                                                if (newValue!) {
                                                  logFirebaseEvent(
                                                      'CHAT_2_INVITE_USERS_KUNDE_CheckboxListTi');
                                                  // addUser
                                                  logFirebaseEvent(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          logFirebaseEvent(
                              'CHAT_2_INVITE_USERS_KUNDE_SEND_INVITES_B');
