              ...
              Padding(
                ...
                child: Text(
                  FFLocalizations.of(context).getText(
                    'fnkl9nxv' /* Gravity Administration */,
                  ),
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  'tabjc6o9' /* Let's get started by filling o... */,
                                                ),
                                                textAlign: TextAlign.start,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                FFLocalizations.of(context)
                                                    .getText(
                                                  '6u28aa3d' /* Fill out the information below... */,
                                                ),
                                                textAlign: TextAlign.start,
                                                style:
                                                    FlutterFlowTheme.of(context)
