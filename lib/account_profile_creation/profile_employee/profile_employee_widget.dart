                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  ...
                                  await launchUrl(Uri(
                                    scheme: 'tel',
                                    path:
                                        profileEmployeeUsersRecord.phoneNumber,
                                  ));
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                              ...
                              return SingleChildScrollView(
                                ...
                                child: Row(
                                  ...
                                  children: List.generate(
                                      rowItskillsRecordList.length, (rowIndex) {
                                  ...
                                  }).divide(const SizedBox(width: 15.0)).around(
                    ...
                    StreamBuilder<List<CustomerMeetingRecord>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        List<CustomerMeetingRecord>
                            listViewCustomerMeetingRecordList = snapshot.data!;
