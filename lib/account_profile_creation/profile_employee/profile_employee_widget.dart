              ...
              child: Scaffold(
                ...
                appBar: AppBar(
                  ...
                  leading: FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent(
                          'PROFILE_EMPLOYEE_arrow_back_rounded_ICN_');
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        ...
                                        await launchUrl(Uri(
                                          scheme: 'mailto',
                                          path:
                                              profileEmployeeUsersRecord.email,
                                        ));
                                      },
                                      child: Row(
                                        mainAxisSize: MainAxisSize.max,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'yv1tophe' /* An overview of their adress. */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .labelMedium
                                                .override(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PROFILE_EMPLOYEE_Row_b4nn0dc1_ON_TAP');
                                            if (isWeb) {
                                              return;
                                            }
                                      ...
                                      Padding(
                                        ...
                                        child: InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'PROFILE_EMPLOYEE_Row_ttzxjd7n_ON_TAP');
                                            logFirebaseEvent('Row_send_email');
                                            await launchUrl(Uri(
                                              scheme: 'mailto',
                                              path: profileEmployeeUsersRecord
                                        ...
                                        child: SingleChildScrollView(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                profileEmployeeUsersRecord.town,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                              ...
                                              Text(
                                                profileEmployeeUsersRecord.zip,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    FFLocalizations.of(context).getText(
                                      'r2wup95a' /* An overview of their customer ... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
